...
public class DomainRangeConstraintKernel extends AbstractKernel implements ConstraintKernel {
	...
	public void groundConstraint(GroundAtom atom, AtomManager atomManager, GroundKernelStore gks) {
	...
	public void registerForAtomEvents(AtomEventFramework manager) {
		...
		manager.registerAtomEventListener(AtomEvent.ActivatedEventTypeSet, predicate, this);
	}
	...
	public void unregisterForAtomEvents(AtomEventFramework manager) {
		...
		manager.unregisterAtomEventListener(AtomEvent.ActivatedEventTypeSet, predicate, this);
	}
